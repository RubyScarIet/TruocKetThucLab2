...
function UserDetail() {
  ...
  // Nếu không có userId, không render gì
  if (!userId) {
  ...
  console.log("UserDetail - user found:", user);

  // Nếu không tìm thấy người dùng
  if (!user) return <Typography variant="h6" sx={{ p: 2 }}>Không tìm thấy dữ liệu người dùng. (ID: {userId})</Typography>;
